...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 17:33:14 2018

@author: hunter
"""

#Exercise 7 (rank_test: 2 points). Write some code to create a new list, 
#rank, which contains the names of students in order by decreasing score. 
#That is, rank[0] should contain the name of the top student (highest average 
#exam score), and rank[-1] should have the name of the bottom student 
#(lowest average exam score).
...
#turn avg_grades_by_student into a list in descending order called rank
